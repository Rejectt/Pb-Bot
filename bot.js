...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,' Delavance Inc™ Pb Bot ','Type !help |!support |!invite ',`${client.users.size} Members`,'!invite','By: Delavance Inc™ | Pb Bot'];
    var i = -1;
    var j = 0;
...
client.on("message", message => {
 if (message.content === "!invite") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('©PbBot :heart: جميع الحقوق محفوظة 2018 لــبوت')
      .addField('Pb Botخدامك ل بروميوم بوت', `https://modest-lewin-146a75.netlify.com`)
...
client.on("message", message => {
 if (message.content === "!support") {
  const embed = new Discord.RichEmbed()
      .setTitle('Click here')
      .setURL(' https://discord.gg/TZBkDcv ')
      .setColor("RANDOM")
      .setFooter('© PbBot :heart: جميع الحقوق محفوظة 2018 لــبوت')  
      .addField('سيرفر الدعم الفني', ` https://discord.gg/TZBkDcv  `)
  message.author.send({embed});
...
if (message.content.startsWith('!server')) {
 message.channel.send(`Here is the different information of **${message.guild.name}**`, {
  ...
  var prefix = "!";
    client.on('message', message => {
    if(message.content.startsWith(prefix + '1avatar')) {
